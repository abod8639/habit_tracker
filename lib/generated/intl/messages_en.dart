...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static String m1(count) =>
      "${Intl.plural(count, one: 'You have 1 task left to complete today.', other: 'You have ${count} tasks left to complete today.')}";
  ...
  static String m4(message) => "Failed to clear data: ${message}";

  static String m5(count) => "${count} habits generated for you";

  static String m6(hours) => "${hours} hours ago";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
    ...
    "answerRequired": MessageLookupByLibrary.simpleMessage("Answer required"),
    ...
    "categorySports": MessageLookupByLibrary.simpleMessage("Sports & Fitness"),
    ...
    "clearingData": MessageLookupByLibrary.simpleMessage("Clearing data..."),
    ...
    "currentlySelected": MessageLookupByLibrary.simpleMessage(
      "Currently Selected",
    ),
    ...
    "dailyReminderTitle": MessageLookupByLibrary.simpleMessage("Habit Tracker"),
    ...
    "detectedHabits": MessageLookupByLibrary.simpleMessage("Detected Habits"),
    ...
    "generateMyPlan": MessageLookupByLibrary.simpleMessage(
      "Generate My Plan ✨",
    ),
    ...
    "themeNotFound": MessageLookupByLibrary.simpleMessage("Theme not found"),
